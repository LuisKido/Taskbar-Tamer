...
public static class PartFactory
{
    ...
    public static Stats BaseTemplate(AnatomySlot slot) => slot.Category() switch
    {
        SlotCategory.Offense => new Stats(
            MaxHp: 0, Attack: 50, Defense: 0, Speed: 0,
            CritChance: 300, CritDamage: 0, Evasion: 0, StatusPower: 0),

        SlotCategory.Defense => new Stats(
            MaxHp: 200, Attack: 0, Defense: 40, Speed: 0,
            CritChance: 0, CritDamage: 0, Evasion: 0, StatusPower: 0),

        _ => new Stats(
            MaxHp: 0, Attack: 0, Defense: 0, Speed: 30,
            CritChance: 0, CritDamage: 0, Evasion: 300, StatusPower: 0),
    };
